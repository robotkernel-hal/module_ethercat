...
class MainProject(ConanFile):
    ...
    requires = [
            ...
            "service_provider_memory_inspection/5.1.0@robotkernel/unstable",
            "service_provider_canopen_protocol/5.1.0@robotkernel/unstable",
            "service_provider_key_value/5.1.0@robotkernel/unstable",
            "service_provider_sercos_protocol/5.1.0@robotkernel/unstable",
            "service_provider_file_protocol/5.1.0@robotkernel/unstable",
            "service_provider_process_data_inspection/5.1.0@robotkernel/unstable",
